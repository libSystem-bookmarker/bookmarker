...
public class AdminDAO {
	...
	/**
	 * @author ys.kim
	 * 사용자의 아이디와 이름을 받아와 정보를 삭제하는 메서드
	 */
	...
	/**
	 * @author ys.kim
	 * 사용자의 role이 student일 경우 리스트를 조회
	 */
